...
export const SidebarLink = ({
  ...
  return (
    <Link
      to={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-2 rounded-lg transition-all duration-150",
        className
      )}
      style={{
    ...
    >
      ...
      <motion.span
        ...
        className="text-sm group-hover/sidebar:translate-x-1 transition-transform duration-150 whitespace-pre inline-block !p-0 !m-0"
        style={{ color: "var(--text-primary)" }}
      >
        {link.label}
      </motion.span>
